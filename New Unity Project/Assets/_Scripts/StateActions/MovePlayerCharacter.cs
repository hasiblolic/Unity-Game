	...
	void HandleAnimations()
	{
		if (states.isGrounded)
		{
			if (states.lockOn)
			{
				...
				states.anim.SetFloat("Vertical", f); //.2f, states.delta);
				...
				states.anim.SetFloat("Horizontal", s);// .2f, states.delta);
			}
			else
			{
				...
				states.anim.SetFloat("Vertical", f, .02f, states.delta);
				states.anim.SetFloat("Horizontal", 0);// 0.2f, states.delta);
			}
		}
		else
		{
